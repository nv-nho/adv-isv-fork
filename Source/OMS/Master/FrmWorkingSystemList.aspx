<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="FrmWorkingSystemList.aspx.cs" Inherits="OMS.WorkingSystem.FrmWorkingSystemList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <cc1:ICodeTextBox ID="txtWorkingSystemCD" runat="server" CssClass="form-control input-sm" AjaxUrlMethod="GetWorkingSystemCD" LabelNames="txtWorkingSystemCD"/>
                    </div>
                </div>
                <%--WorkingSystem Name--%>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label" for="<%= txtWorkingSystemName.ClientID %>">
                            勤務体系名称</label>
                        <cc1:ITextBox ID="txtWorkingSystemName" runat="server" CssClass="form-control input-sm"></cc1:ITextBox>
                    </div>
                </div>
            </div>
    ...
    <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
        ...
        <asp:Repeater ID="rptWorkingSystemList" runat="server">
            <HeaderTemplate>
                <tbody>
            </HeaderTemplate>
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="btnDetail" runat="server" CommandArgument='<%# Eval("ID") %>'
                            PostBackUrl="FrmWorkingSystemEntry.aspx" OnCommand="btnDetail_Click" CssClass="btn btn-info btn-sm loading"> 
                            <span class="glyphicon glyphicon-pencil"></span>
                        </asp:LinkButton>
                    </td>
                    <td>
                        <%# Eval("WorkingSystemCD")%>
                    </td>
                    <td>
                        <%# Eval("WorkingSystemName")%>
                    </td>
                    <td>
                        <%# Eval("WorkingSystemName2")%>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
